...
export const metadata = {
  title: 'NLW Spacetime',
  description: 'Uma cápsula do tempo construída com React, Next.js, TypeScript e Tailwind!',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body 
      className={`${roboto.variable} ${baiJamjuree.variable} font-principal bg-gray-900 text-gray-100`}>
